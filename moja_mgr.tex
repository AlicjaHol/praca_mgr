...
Rysunek \ref{fig:latent-spaces} przedstawia przestrzeń ukrytą autoenkodera wariancyjnego użytego do generowania obrazów cyfr na podstawie zbioru MNIST. Przestrzeń ukryta została narysowana dla predykcji z kodera dla zbioru testowego.
